 ...
 */
 ...
 class Y extends X{static get styles(){return K`
     ...
     `}static get properties(){return{title:{type:String}}}constructor(){super()}render(){return N`
       <link rel="preconnect" href="https://fonts.gstatic.com">
       <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@500&display=swap" rel="stylesheet">
       <h1>${this.title}</h1>
       <slot></slot>
     `}_onClick(){this.count++}}window.customElements.define("zizi-card",Y);export{Y as ZiziCard};
